...
function createNote(body, notesArray) {
    ...
    fs.writeFileSync( 
        path.join(__dirname, '../db.db.json'), //Writes the new animal data to our animals.json file in the data subdirectory by using the method path.join() to join the value of __dirname
